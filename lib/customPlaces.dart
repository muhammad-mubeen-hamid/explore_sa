      ...
      child: Column(
        children: [
              ...
              GestureDetector(
                child: Expanded(
                    ...
                    child: Container(
                      ...
                      child: Icon(Icons.navigation_rounded, color: MyColors.xLightTeal, size: 30,),
                        ...
                        borderRadius: new BorderRadius.circular(10),
                          child: Image(
                            ...
                            image: NetworkImage(
                                ...
                                "https://maps.googleapis.com/maps/api/place/photo?maxwidth=195&photoreference=${Globals.favPlacesImages[itemIndex]}&key=AIzaSyB0POtgaIRmp1NhRH3PGPcQ14Uo6MQ1OJI",
                            ),
                          ),
          ...
          Container(
            ...
            width: width,
            child: Accordion(
              headerBackgroundColor: MyColors.darkTeal,
              contentBackgroundColor: Colors.white,
              contentBorderColor: MyColors.darkTeal,
              ...
              children: [
                AccordionSection(
                  leftIcon: Icon(Icons.preview_rounded, color: MyColors.xLightTeal,),
                  isOpen: true,
                  headerText: 'Overview',
                  content: Container(
                    child: Column(
                ...
                AccordionSection(
                  leftIcon: Icon(Icons.rate_review_rounded, color: MyColors.xLightTeal,),
                  isOpen: false,
                  headerText: 'Reviews',
                ...
                AccordionSection(
                  leftIcon: Icon(Icons.info_rounded, color: MyColors.xLightTeal,),
                  isOpen: false,
